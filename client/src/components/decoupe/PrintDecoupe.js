...
<div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
  ...
  <div style={{ display: "flex", alignItems: "center" }}>
<label htmlFor="sig1" style={{ marginRight: "150px" , marginBottom: "10px" }}>Signature chef de production </label>
{vente.sig1}               


<label htmlFor="chef" style={{ marginRight: "150px", marginBottom: "10px" }}>   Signature CQH </label>
{vente.sig2}  
