...
<table style={{ borderCollapse: "collapse", padding: "80px", margin: "auto", width: "500px", marginBottom: '90px' }}>
<thead>
  <tr style={{ textAlign: 'center', fontSize: '16px' }}>
    <th></th>
    <th colSpan="13">
      <p style={{ fontSize: "16px", width: "1000px", margin: "auto", textAlign: "center" }}>
        Environnement Usine
      </p>
    </th>
  </tr>
